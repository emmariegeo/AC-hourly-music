...
// Utility Lists
const SKY_COLORS = ['#000334','#1e1a42','#000a40','#04114b','#0e114b','#1b4067','#86beab','#b7cef9', '#7abcfd', '#55a5ff','#60b3ff','#5eb7ff','#4697fe','#3b83ff','#4c8eff','#82b6ff', '#95c1ff', '#adacf4', '#ff9870','#151d51','#001759', '#000c46','#010940', '#1f193f','#1a143a'];
...
function getBackground() {
    if (hour == 23) {
        BODY.style.background = "linear-gradient("+SKY_COLORS[hour-1]+", "+SKY_COLORS[hour]+")";
    } else if (hour < 12) {
        BODY.style.background = "linear-gradient("+SKY_COLORS[hour]+", "+SKY_COLORS[hour+1]+")";
    } else {
        BODY.style.background = "linear-gradient("+SKY_COLORS[hour+1]+", "+SKY_COLORS[hour]+")";
    }
}
